...
<!-- See the section about [building](https://vitejs.dev/guide/static-deploy.html) for more information. -->
...
You can check a curated list of [awesome things related to Vite.js](https://github.com/vitejs/awesome-vite#templates)
